...
const NumberTicker = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center px-4 sm:px-8 lg:px-16 py-12 bg-gray-50">
      {/* Text Content */}
      <div>
      ...
      <div className="relative w-full max-w-lg md:ml-auto">
        <img
          src={image}
          alt="Frontline BD Image"
