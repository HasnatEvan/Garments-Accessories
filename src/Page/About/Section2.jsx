...
const people = [
  ...
  },
  {
    ...
    image: image2,
    description: `Md. Hasmat Ullah is also the founder and jointly partnered with these corporate houses. He contains strong expertise in business development and client relationship management. He plays a key role in ensuring smooth communication with partners and clients. His proactive approach and commitment to excellence help drive the company’s growth and maintain long-term partnerships.`,
  },
];
    ...
    <section className="py-16 px-4 sm:px-6 lg:px-20 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-7xl mx-auto">
        {people.map((person, index) => (
          <div
            key={index}
            className="p-6 sm:p-8 rounded-lg shadow-md hover:shadow-lg transition duration-300 flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 bg-white relative"
            style={{
